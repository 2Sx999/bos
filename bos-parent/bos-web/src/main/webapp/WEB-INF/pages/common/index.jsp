...
<head>
    ...
    <link rel="stylesheet"
          ...
          type="text/css"/>
    <script
            src="${pageContext.request.contextPath }/js/ztree/jquery.ztree.all.min-3.5.33.js"
        ...
        <tr>
            <td style="width: 300px;">
                <div style="color: #999; font-size: 8pt;">
                    porkchop.cn | Powered by <a href="https://github.com/qq714772696/bos" target="_blank">bos</a>
                </div>
            </td>
                ...
                <table cellpadding=3>
                    <tr>
                        ...
                        <td><input id="txtNewPass" type="Password" class="txt01 easyui-validatebox"
                                   data-options="required:true,validType:'length[3,20]'"/></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
