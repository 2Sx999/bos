    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#telephone").blur(function () {
                $.post("${pageContext.request.contextPath}/NoticeBillAction_findCustomerByTelephone",
...
<div region="center" style="overflow:auto;padding:5px;" border="false">
    <form id="noticebillForm" action="${pageContext.request.contextPath}/NoticeBillAction_add.action" method="post">
        <table class="table-edit" width="95%" align="center">
            ...
            <tr>
                <td>取件地址</td>
                <td colspan="3"><input type="text" class="easyui-validatebox" name="pickaddress" required="true"
                                       size="144"/></td>
            </tr>
            <tr>
                <td>到达城市:</td>
