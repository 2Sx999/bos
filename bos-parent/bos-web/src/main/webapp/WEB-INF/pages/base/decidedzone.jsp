...
<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false"
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="addDecidedzoneForm" method="post" action="${pageContext.request.contextPath}/DecidedZoneAction_add">
                ...
                <tr>
                    ...
                    <td>
                        <input class="easyui-combobox" name="staff.id"
                               data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/StaffAction_findAllUndeletedStaff.action'"/>
                    </td>
                </tr>
                <tr height="300">
                    ...
                    <td>
                        <table id="subareaGrid" class="easyui-datagrid" border="false" style="width:300px;height:300px"
                               data-options="url:'${pageContext.request.contextPath}/SubareaAction_findUnconnecteToDecidedZone.action',fitColumns:true,singleSelect:false">
                            <thead>
                            <tr>
                                <th data-options="field:'subareaId',width:30,checkbox:true">
                                    编号
                                </th>
