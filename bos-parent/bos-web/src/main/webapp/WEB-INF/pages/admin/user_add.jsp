...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //加载角色
            $.post("${pageContext.request.contextPath}/RoleAction_findAll.action", {}, function (data) {
                for (var i = 0; i < data.length; i++) {
                    $("#roleTD").append("<input id='" + data[i].id + "' type='checkbox' name='roleIds' value='" + data[i].id +
