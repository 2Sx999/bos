...
<div data-options="region:'center'">
    <form id="functionForm" method="post" action="${pageContext.request.contextPath}/FunctionAction_add.action">
        <table class="table-edit" width="80%" align="center">
            ...
            <tr>
                <td>访问路径</td>
                <td><input type="text" name="fucntionPage"/></td>
            </tr>
            <tr>
                <td>是否生成菜单</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input name="parentFunction.id" class="easyui-combobox"
                           data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/FunctionAction_findAll.action'"/>
                </td>
            </tr>
            <tr>
                <td>描述</td>
